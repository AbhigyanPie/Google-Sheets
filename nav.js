...
// Function to load title from local storage
function loadTitle() {
    const storedTitle = localStorage.getItem('spreadsheetTitle');
    if (storedTitle) {
        titleElement.textContent = storedTitle;
    } else {
        titleElement.textContent = 'Untitled spreadsheet';
    }
}

// Function to save title to local storage
function saveTitle() {
    localStorage.setItem('spreadsheetTitle', titleElement.textContent);
}
...
titleElement.addEventListener('dblclick', function() {
    ...
    this.addEventListener('blur', function() {
        ...
        saveTitle(); // Save title when editing is complete
    });
...
// {
//     let sheetAddBtn = document.querySelector(".spreadsheet");
//     sheetAddBtn.click();
// }
